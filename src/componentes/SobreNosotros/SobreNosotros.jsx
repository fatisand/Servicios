  ...
  return (
    <>
      <section id='sobrenosotros' className={styles.container}>
        ...
        <p>
          En <strong>ArtiFact</strong>, nos especializamos en transformar tus ideas en realidades sorprendentes. Fundada con la visión de revolucionar el mundo de la arquitectura, nuestra consultoría se dedica a ofrecer soluciones innovadoras y personalizadas que combinan funcionalidad, estética y sostenibilidad.
        </p>
        <p>
        ...
        <p>
          ...
          Estamos listos para colaborar contigo en tu próximo proyecto. Descubre cómo <strong>ArtiFact</strong> puede transformar tu visión en realidad. Ponte en contacto con nosotros para una consulta inicial y da el primer paso hacia un diseño innovador y personalizado.
        </p>
        </div>
      </section>
    </>
